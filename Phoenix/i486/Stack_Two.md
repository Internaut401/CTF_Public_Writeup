...
```
## STRATEGY
We need fill the buffer with junk and then overwrite changeme with given hexadecimal address, for integer casting problem i decide to write the address in endianess way by hand
